...
mod tests {
    ...
    fn reading_hashmap_works() {
        ...
        let orig: HashMap<i32, f64> = [1., 2., 3.]
            .iter()
            .enumerate()
            .map(|(k, v)| (k as i32, *v as f64))
            .collect();
    ...
    fn reading_hashmap_with_complex_indexes_works() {
        ...
        lua.execute::<()>(r#"v = { [-1] = -1, ["foo"] = 2, [2.] = 42 }"#)
            .unwrap();
